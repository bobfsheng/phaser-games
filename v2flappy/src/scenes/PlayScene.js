...
class PlayScene extends BaseScene {
    constructor(config) {
        ...
        console.log("in playscene constructor");
        console.log(config);
    ...
    createPause() {
        this.isPaused = false;
        const pauseButton = this.add.image(this.config.width - 10, 50, 'pause')
    ...
    listenToEvents() {
        ...
        if (!this.startEvent) {
            ...
            this.startEvent = this.events.on(Phaser.Scenes.Events.READY, () => {
    ...
    gameOver() {
        ...
        // this.saveBestScore();
        this.game.config.scoreHandler(this.score);
